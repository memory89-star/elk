...
use frontend\modules\elk\models\search\KodSearch;
...
class KodController extends BasesemController
{
...
//        $model->user_first = Yii::$app->user->identity->username;
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $url = $this->getCurrentUrl(Kod::className());
        ...
        $this->setCurrentUrl(Kod::className());
    ...
    {
        $model = $this->findModel(Kod::className(), $id);
        $modelOld = $this->findModel(Kod::className(), $id);
