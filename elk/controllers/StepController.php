...
use frontend\modules\elk\models\search\StepSearch;
...
class StepController extends BasesemController
{
...
//        $model = $this->findModel(Auditors::className(),$id);
...
//        $model->user_first = Yii::$app->user->identity->username;
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $url = $this->getCurrentUrl(Step::className());
        ...
        $this->setCurrentUrl(Step::className());
        ...
        if (Yii::$app->request->isAjax){
            return $this->renderAjax('modalForm', [
                ...
                'date_time_update' => $model->time_update.' '.$model->time_update,
            ]);
        } else {
    ...
    {
        $model = $this->findModel(Step::className(), $id);
        $modelOld = $this->findModel(Step::className(), $id);
