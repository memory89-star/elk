...
/* @var $model frontend\modules\elk\models\Kod */
...
<div class="kod-form">
    ...
    <div class="row">
        <div class="col-md-3">
            <?= $form->field($model, 'kod_objects')->textInput(['maxlength' => true, 'placeholder' => 'Ввод кода объекта']) ?>
        </div>
    ...
    <div class="modal-footer">
        ...
        <?= Html::a('Выйти', ['kod/index'], ['class' => 'btn coca_cola_gray']) ?>
    </div>
