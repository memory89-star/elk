...
$role1 = Yii::$app->user->can('elk_admin')||Yii::$app->user->can('elk_user_gxk');
$role2 = (Yii::$app->user->can('elk_user_dep')&&$model->userDepartmentIdK(Yii::$app->user->identity->id) ? true : false);
$role3 = (Yii::$app->user->can('elk_user_dep')&&$model->userDepartmentId(Yii::$app->user->identity->id) ? true : false);
?>
...
<div class="reestr-form">
    ...
    <div class="row">
        <div class="col-md-3">
            <?php if ($role3 || $role1) {
                echo $form->field($model, 'date_detection')->widget(DateControl::classname(), [
            ...
            <?php } else {
                echo $form->field($model, 'date_detection')->widget(DateControl::classname(), [
                        'options' => ['placeholder' => 'Введите дату ...', 'disabled' => 'true'],
                        'disabled' => ($role3 || $role1) ? false :true,
                        'type' => DateControl::FORMAT_DATE,
                        'widgetOptions' => [
                            'pluginOptions' => [
                            'autoclose' => true,
            ...
            ?>
             <?php } else {
              echo $form->field($model, 'id_step')->widget(Select2::className(), [
                ...
                'maintainOrder' => true,
                'options' => [
                    'placeholder' => 'Укажите этап реализации',  'disabled' => 'true'
                    ],
                'pluginOptions' => ['allowClear' => true],
                ]);
             } ?>
        ...
        <div class="reestr-form--row__id_department_kontrolling col-md-6">
           ...
           <?php } else {
              echo $form->field($model, 'id_department_kontrolling')->widget(Select2::className(), [
                ...
                'maintainOrder' => true,
                'options' => [
                    'placeholder' => 'Укажите контролируемое подразделение',  'disabled' => 'true'
                    ],
                'pluginOptions' => ['allowClear' => true],
             ]); } ?>
    ...
    <div class="action-form--row__manager col-md-4">
       ...
       <?php } else {
          echo $form->field($model, 'manager')->widget(Select2::className(), [
            ...
            'maintainOrder' => true,
            'options' => [
                'placeholder' => 'Укажите ответственного...', 'disabled' => 'true',
                'id' => 'manager'
                ],
            'pluginOptions' => ['allowClear' => true],
            ]);
    ...
    <div class="reestr-form--row__incongruity col-md-9">
        <?php if ($role3 || $role1) {
          echo $form->field($model, 'incongruity')->textInput(['maxlength' => true]) ?>
        <?php } else {
          echo $form->field($model, 'incongruity')->textInput(['maxlength' => true,'readonly' => 'true']);  } ?>
    </div>
    <!-- /Несоответствие/наблюдение  -->
    ...
    <div class="reestr-form--row__requirements_not_met col-md-9">
        <?php if ($role3 || $role1) {
           echo $form->field($model, 'requirements_not_met')->textInput(['maxlength' => true]) ?>
        <?php } else {
           echo $form->field($model, 'requirements_not_met')->textInput(['maxlength' => true,'readonly' => 'true']);  } ?>
    ...
    <div class="reestr-form--row__events_elimination col-md-9">
       <?php if ($role2 || $role1) {
            echo $form->field($model, 'events_elimination')->textInput(['maxlength' => true]) ?>
       <?php } else {
            echo $form->field($model, 'events_elimination')->textInput(['maxlength' => true, 'readonly' => 'true']) ;  }?>
    </div>
    <!-- Мероприятия по устранению несоответствий  -->
    ...
    <div class="reestr-form--row__events_elimination col-md-9">
        <?php if ($role3 || $role1) {
          echo $form->field($model, 'reason_modification')->textInput(['maxlength' => true]) ?>
        <?php } else {
          echo $form->field($model, 'reason_modification')->textInput(['maxlength' => true, 'readonly' => 'true']); } ?>
    ...
    <div class="row  reestr-date">
        ...
        <div class="col-md-3">
            <?php if ($role2 || $role1) {
                echo $form->field($model, 'date_plan')->widget(DateControl::classname(), [
            ...
            <?php } else {
                echo $form->field($model, 'date_plan')->widget(DateControl::classname(), [
                    ...
                    'disabled' => ($role2 || $role1) ? false :true,
                    'type' => DateControl::FORMAT_DATE,
                    'widgetOptions' => [
                        'pluginOptions' => [
                        'autoclose' => true,
        ...
        <div class="col-md-3">
            <?php if ($role2 || $role1) {
              echo $form->field($model, 'date_fact')->widget(DateControl::classname(), [
        ...
        <div class="reestr-form--row__id_kontrol col-md-6">
            ...
            <?php } else {
                 echo $form->field($model, 'id_kontrol')->widget(Select2::className(), [
                    ...
                    'maintainOrder' => true,
                    'options' => [
                    'placeholder' => 'Укажите контролирующего', 'disabled' => 'true'],
                    'pluginOptions' => ['allowClear' => true],
                    ]); }
            ?>
        </div>
