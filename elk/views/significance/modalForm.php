...
/* @var $model frontend\modules\elk\models\Significance */
...
<div class="significance-form">

    <?php $form = ActiveForm::begin([
        'id' => 'modal-significance-form',
    ...
    <div class="modal-footer">
        ...
        <?= Html::a('Выйти', ['significance/index'], ['class' => 'btn coca_cola_gray']) ?>
    </div>
